...
<html lang="en">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      <h1 style="color: #556B2F;">User Profile</h1>
      <ol class="breadcrumb">
    ...
    <div class="content"> 
      ...
      <div class="row m-t-3">
        <div class="col-lg-12">
          <div class="card ">
            <div class="card-header bg-blue" style=" background: linear-gradient(to bottom, #33ccff 0%, #9900ff 100%);">
...
$update="update persons set name='".$name."', email='".$email."', number='".$number."' where email='$email'";
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="form-group has-feedback">
                    <label class="control-label" style="color: #996600;">Name</label>
                ...
                <div class="col-md-8">
                  <div class="form-group has-feedback">
                    <label class="control-label" style="color: #0000ff;">E-mail</label>
                ...
                <div class="col-md-8">
                  <div class="form-group has-feedback">
                    <label class="control-label" style="color: #660066;">Contact Number</label>
                    <input class="form-control" placeholder="Contact Number" type="text" name="mobile" value="<?php echo $row['number']?>"> 
                    <span class="fa fa-phone form-control-feedback" aria-hidden="true"></span> </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group has-feedback">
                    <label class="control-label" style="color:#cc0000">Address</label>
                ...
                <div class="col-md-8">
                  <div class="form-group has-feedback">
                    <label class="control-label" style="color: #00ff00;">Date Of Birth</label>
                    <input class="form-control" placeholder="Date Of Birth" type="text" name="dob" value="<?php echo $row['date_of_birth']?>"> 
                    <span class="" aria-hidden="true"></span> </div>
                </div>
